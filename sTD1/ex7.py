...
# Au fur et à mesure du traitement de la liste, on mémorisera
# dans la variable ci-dessous la valeur du plus grand élément
# déjà trouvé :
...
tt = [32, 5, 12, 8, 3, 75, 2, 15]
print "Le plus grand élément de cette liste a la valeur", max(tt)